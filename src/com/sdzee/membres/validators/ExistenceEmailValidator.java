...
public class ExistenceEmailValidator implements Validator {
    ...
    private static final String EMAIL_ALREADY_EXISTS = "Cette addresse email est déjà utilisée.";
    ...
    public void validate( FacesContext context, UIComponent component, Object value ) throws ValidatorException {
        ...
        try {
            if ( memberDao.find( "email", email ) != null ) {
                /*
                ...
                throw new ValidatorException(
                        new FacesMessage( FacesMessage.SEVERITY_ERROR, EMAIL_ALREADY_EXISTS, null ) );
            }
