...
public class ExistencePseudoValidator implements Validator {
    ...
    private static final String NICKNAME_ALREADY_EXISTS = "Ce pseudo est déjà utilisé.";
    ...
    public void validate( FacesContext context, UIComponent component, Object value ) throws ValidatorException {
        ...
        try {
            if ( memberDao.find( "nickName", nickName ) != null ) {
                /*
                ...
                throw new ValidatorException(
                        new FacesMessage( FacesMessage.SEVERITY_ERROR, NICKNAME_ALREADY_EXISTS, null ) );
            }
