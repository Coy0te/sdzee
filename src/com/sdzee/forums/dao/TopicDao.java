...
/**
 * TopicDao est la classe DAO contenant les opérations CRUD réalisables sur la table des sujets d'un forum. Il s'agit d'un EJB Stateless
...
public class TopicDao {
     ...
     * 
     * @param forum le forum dans lequel effectuer la recherche.
     * @return la liste des sujets épinglés dans un forum triés par id par ordre décroissant, ou <code>null</code> si aucun sujet n'est
     *         trouvé.
     * @throws {@link DAOException} lorsqu'une erreur survient lors de l'opération en base.
     */
