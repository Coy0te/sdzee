...
CREATE TABLE `forum_reponse` (
  ...
  KEY `fk_lastEditBy_reponse` (`lastEditBy`),
...
CREATE TABLE `forum_sujet` (
  ...
  KEY `fk_lastEditBy_sujet` (`lastEditBy`),
...
INSERT INTO `forum_vote` VALUES (1,1,'reponse',1),(1,1,'sujet',-1),(1,3,'reponse',1),(1,4,'reponse',-1),(1,13,'sujet',-1),(1,14,'sujet',-1),(2,1,'reponse',-1),(2,1,'sujet',-1),(2,2,'reponse',1),(2,4,'reponse',1),(2,6,'reponse',-1),(2,8,'reponse',-1),(2,9,'reponse',1),(2,10,'reponse',1),(2,13,'sujet',-1);
